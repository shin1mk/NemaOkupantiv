...
final class NezlamnistViewController: UIViewController, WKNavigationDelegate {
    //MARK: - Properties
    ...
    // load web page
    public func loadPointPage() {
//        guard let url = URL(string: "https://tdukr.maps.arcgis.com/apps/webappviewer/index.html?id=3bda8793df344cbb95362d1dbad160e6&") else {
        guard let url = URL(string: "https://misto.lun.ua/svitlo?ls=nezlamnist%2Csvitlo-coworking%2Csvitlo-coffee-resto%2Csvitlo-products%2Csvitlo-azs%2Csvitlo-health%2Csvitlo-household%2Csvitlo-electronics%2Csvitlo-clothes%2Csvitlo-beauty%2Csvitlo-sport%2Csvitlo-pets%2Csvitlo-auto%2Csvitlo-vacation%2Csvitlo-children%2Csvitlo-post%2Csvitlo-money%2Csvitlo-other#15.01/48.5144/35.02564") else {
            return
        }
...
//MARK: extension
extension NezlamnistViewController: CLLocationManagerDelegate {

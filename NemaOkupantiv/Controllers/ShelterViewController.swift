...
final class ShelterViewController: UIViewController, WKNavigationDelegate {
    //MARK: - Properties
    ...
    // load web page
    public func loadShelterPage() {
        guard let url = URL(string: "https://misto.lun.ua/shelters?ls=shelters-private%2Cshelters-municipal%2Cshelters-other#5.93/48.644/31.607") else {
            return
        }
...
//MARK: extension
extension ShelterViewController: CLLocationManagerDelegate {

...
final class SaveEcoViewController: UIViewController, WKNavigationDelegate {
    //MARK: - Properties
    ...
    // load web page
    public func loadSaveEcoPage() {
        guard let url = URL(string: "https://www.saveecobot.com/maps#10/50.3766/30.4108/aqi") else {
            return
        }
...
//MARK: extension
extension SaveEcoViewController: CLLocationManagerDelegate {
